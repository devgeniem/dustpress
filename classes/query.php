...
class Query {
     ...
     * @param boolean $query_object  Whether to use the whole query object.
     ...
     * @since   0.0.1
     *
     * @param  array        $post       A reference to the queried post.
     ...
     */
    private static function get_post_meta( &$post, $id, $meta_keys = null, $single = false ) {
        $meta = array();
     ...
     * @since   0.0.1
     *
     * @param  array        $posts     A reference to the queried post.
     * @param  array/string $meta_keys Wanted meta keys or string 'ALL' to fetch all.
     * @param  boolean      $single    If true, return only the first value of the specified meta_key.
     */
