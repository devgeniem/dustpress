...
// FIXME -> WP function
        ...
        // Ensure all needed partials are present.
        $this->dust->includedDirectories = array_unique( array_merge( $this->dust->includedDirectories, $this->get_template_paths( 'partials' ) ) );
